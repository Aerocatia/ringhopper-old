...
pub(crate) static ALL_VERBS: &'static [VerbInfo] = &[
    ...
    VerbInfo::new(Verb::NormalizeLightmaps, "normalize-lightmaps", get_compiled_string!("verb.normalize-lightmaps.description")),
    ...
    VerbInfo::new(Verb::RecoverProcessed, "recover-processed", get_compiled_string!("verb.recover-processed.description")),
